  ...
  return (
    <div className="max-w-6xl mx-auto pb-20 animate-in fade-in duration-500">
       <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex bg-white rounded-lg p-1 shadow border border-slate-200 overflow-x-auto">
             <button onClick={() => setTab('acts')} className={`px-4 py-2 text-sm font-medium rounded transition-all whitespace-nowrap ${tab === 'acts' ? 'bg-blue-600 text-white shadow' : 'text-slate-600 hover:bg-slate-50'}`}>

  ...
  if (!currentDoc) {
      return (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border-2 border-dashed border-slate-200">
              ...
              <p className="text-slate-500 mb-6 text-center max-w-md">Crea il primo atto ufficiale per questo appalto.</p>
       ...
       <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 min-h-[500px]">
          ...
          {step === 'admin-acts' && isLettera && (
              <div className="animate-in fade-in slide-in-from-right-4 space-y-8">
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg text-xs text-blue-800">
                      <strong>Istruzioni:</strong> Compila il blocco destinatari andando a capo per ogni riga. Verrà posizionato a destra nell'intestazione.
                  </div>
                  <div>
                  ...
                  <div>
                      <label className="block text-xs font-bold text-slate-500 uppercase mb-2 tracking-widest">Corpo della Lettera (Sovrascrivi Testo Predefinito)</label>
                      <textarea disabled={readOnly} className="w-full p-4 border border-slate-300 rounded-lg h-72 text-sm leading-relaxed bg-slate-50 focus:bg-white transition-all shadow-inner" 
                          ...
                          placeholder="Lascia vuoto per utilizzare il testo standard dell'architetto Luigi Resta." />
                  </div>
              </div>
          )}
          ...
          {step === 'works' && isVerbale && (
              <div className="animate-in fade-in slide-in-from-right-4 space-y-6">
                  ...
                  <div>
                      <label className="block text-xs font-bold text-slate-500 uppercase mb-2 tracking-widest">Testo Premesse (Storico Verbali)</label>
                      <textarea disabled={readOnly} className="w-full p-4 border border-slate-300 rounded-lg h-[400px] text-sm leading-relaxed bg-slate-50 focus:bg-white transition-all shadow-inner font-mono" 
                          ...
                          placeholder="Inserisci qui il riepilogo storico delle attività e dei verbali precedenti..." />
                  </div>
              </div>
          )}
       </div>

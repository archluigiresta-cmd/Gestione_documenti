...
export const ExportManager: React.FC<ExportManagerProps> = ({
  ...
  const handlePrint = () => {
    // Usiamo requestAnimationFrame per assicurarci che la UI non venga bloccata istantaneamente
    // e per dare tempo al browser di calcolare il layout di stampa.
    ...
    const htmlDoc = `
      ...
      <head>
        ...
        <style>
          ...
          div#h1 { margin: 0; mso-element: header; }
          div#f1 { margin: 0; mso-element: footer; }
          body {
